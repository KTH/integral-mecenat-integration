...
public class FakeResarchstudentSqlProcessor implements Processor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        row.put("STARTDATUM", Date.from(LocalDate.parse("2018-01-01").atStartOfDay(ZoneId.systemDefault()).toInstant()));
        row.put("SLUTDATUM", Date.from(LocalDate.parse("2018-06-30").atStartOfDay(ZoneId.systemDefault()).toInstant()));
