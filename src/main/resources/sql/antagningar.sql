...
select
    ...
    ,MAX(a.UTBILDNINGSTILLFALLE_STARTDATUM)    AS SLUTDATUM
from UPPFOLJNING.IO_STUDIEDELTAGANDE_ANTAGNING a inner join
    UPPFOLJNING.IO_STUDENTUPPGIFTER s on s.STUDENT_UID = a.STUDENT_UID
 where
